...
haar = cv2.CascadeClassifier('./model_default/haarcascade_frontalface_default.xml')
# pickle files
mean  = pickle.load(open('./model_default/mean_preprocess.pickle','rb'))
model_svm  = pickle.load(open('./model_default/model_svm.pickle','rb'))
model_pca  = pickle.load(open('./model_default/pca_50.pickle','rb'))
